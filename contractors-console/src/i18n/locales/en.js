...
const messages = defineMessages({
  ...
  menu: 'Menu',
  notAContrator: 'Not a contractor',
  ...
  signIn_form_confirmation_notice_description:
    'A confirmation code has been sent to this address "{email}". You will be redirected to the confirmation page where you can use this code to confirm your account.',

  signIn_passwordReset_form_title: 'New password',
  signIn_passwordReset_form_text: 'This password will be used to login to the Conecto Contractor platform.',

  signUp_form_hasAccount: 'Already have an account?',
  signUp_form_iHaveAnAccount: 'I already have an account',
  signUp_form_button_signIn: 'Login',
  signUp_form_title: 'Looking for new customers?',
  signUp_form_checkpoint1:
    'Conecto puts you in contact with qualified applicants in your area',
  signUp_form_checkpoint2: 'Manage your quotes easily and securely',
  signUp_form_checkpoint3: 'Easy, flexible. For all types of contractors',
  signUp_form_labelCompany: 'Company name',
  signUp_form_labelUsername: 'Email',
  signUp_form_labelPassword: 'Password',
  signUp_form_button: 'Create my contractor account',
  signUp_form_labelCompanyName: 'Company name',
  signUp_form_labelCompanyNumber: 'Civic number',
  signUp_form_labelCompanyAddress: 'Company address',
  signUp_form_labelCompanyCity: 'Company city',
  signUp_form_labelCompanyPostalCode: 'Company postal code',
  signUp_form_labelFirstName: 'First name',
  signUp_form_labelLastName: 'Last name',
  signUp_form_labelPhone: 'Mobile phone number',
  signUp_form_labelConfirmPassword: 'Password confirmation',
  signUp_form_labelRBQ: 'RBQ',
  signUp_form_labelNEQ: 'NEQ',
  signUp_form_labelMailing: 'Subscribe to the newsletter',
  signUp_form_labelCondition: 'Accept terms of service',
  signUp_step2_form_title:
    'Before we finish the process, we still need some <span>information</span>.',
  signUp_step2_form_companyTitle: 'Company Information',
  signUp_step2_form_companyAddressTitle: 'Address found',
  signUp_step2_form_contactTitle: 'Contact Information',
  signUp_step2_form_accountTitle: 'Connection information',
  signUp_step2_form_legalTitle: 'Legal Information',
  signUp_step2_form_acceptationTitle: 'Newsletter',
  signUp_step2_form_acceptationText:
    'We will keep you on the lookout for any new features coming on the platform.',
  signUp_step2_form_acceptationConditionText: 'Voir les conditions d\'utilisation',
  signUp_step2_submit_button: 'Submit',
  signUp_confirmation_modal_title: 'Your registration is complete',
  signUp_confirmation_modal_text:
    'A confirmation code has been sent to you by email. You will be redirected to the confirmation page to confirm your account.',
  signUp_confirmation_modal_button: 'Confirm your account',
  code_confirmation_modal_title: 'Your account has been confirmed',
  code_confirmation_modal_text:
    'Your registration is now confirmed. You can now connect.',
  code_confirmation_modal_button: 'Login',
  codeConfirmation_form_title:
    '<span>Confirm your registration </span> by entering the confirmation code you received by email',
  codeConfirmation_form_labelUsername: 'Email',
  codeConfirmation_form_labelPassword: 'Password',
  codeConfirmation_form_labelCode: 'Confirmation code',
  codeConfirmation_form_button_confirmMyAccount: 'Confirm my account',
  codeConfirmation_accountIsConfirmed:
    'Your account has already been confirmed?',
  passwordResetRequest_form_title: 'Reset password',
  passwordResetRequest_form_text:
    'An email containing a password reset code has been sent to you.',
  passwordResetRequest_form_button: 'Reset',
  passwordResetRequest_form_labelUsername: 'Email',
  passwordReset_form_labelNewPassword: 'New email',
  passwordReset_form_labelNewPasswordConfirmation:
    'Confirmation of the new password',
  passwordReset_form_labelCode: 'Code',
  passwordReset_form_button: 'Reset password',
  passwordReset_passwordIsOk: 'Your password is correct?',
  passwordReset_modal_title: 'Your password has been reset',
  passwordReset_modal_text: 'You can now login with the new password',
  passwordReset_modal_button: 'Login',
  passwordReset_form_title: 'Enter your new password',
  passwordReset_form_text:
    'Please enter the reset code and enter the new password. You can then connect.',
  ...
  layoutDashboard_ctaSection_title:
    'Take full advantage of <span> Conecto </ span> by adjusting your profile preferences',
  ...
  dashboardPage_stats_title_competitors: 'Conecto Network',
  ...
  cognito_CodeMismatchException: 'The code is invalid',
  ...
  signIn_form_temporaryPassword_resend_title: 'A temporary password has been generated',
  signIn_form_temporaryPassword_resend_description: 'You will receive an email shortly with a temporary password to log in.',
  signIn_form_notice_error_undefinedCode_title: 'An error has occurred',
  signIn_form_notice_error_undefinedCode_description:
    'The system could not produce the request. Please contact support and provide the following information:\n\n{code}',
  signIn_form_notice_error_undefined_title: 'An error has occurred',
  signIn_form_notice_error_undefined_description:
    'Our system could not produce the request. Please try again later.',
  generic_component_error_title: 'Our systems have difficulty',
  generic_component_error_description:
    'System errors have occurred in recent operations. Please contact support and provide the following information:\n\n{error}\n\n{info}',
  ...
  opportunity_paymentMethod_modal_title: 'You must have determined a payment method in your profile',
  opportunity_paymentMethod_modal_text:
    'You must have a valid payment method to accept the opportunities. Please click on the button below to add one.',
  ...
  opportunity_acceptedDeal_modal_text:
    'This opportunity has been moved to the "In Progress" tab. You can click on the button to consult it.',
  ...
  lead_empty_section_text:
    'This is the page that lists the opportunities you have accepted. You will find the information of your applicants and can contact them according to their contact preferences.',
  ...
  account_paymentMethod_source_make_default_card: 'Use default',
  ...
  account_paymentMethod_source_make_default_notice_title:
    'Modification of the default payment method',
  account_paymentMethod_source_make_default_notice_text:
    'The default payment method has been successfully changed',
  ...
  account_addressesForm_addressesLimitReached:
    'You have reached the limit of the number of addresses you can enter. If you need to add other addresses, please contact support.',
  ...
  labelJobInfoAccordionTitle: 'More informations',
  button_404_back_homepage: 'Back to Home',
  ...
  metaDescription:
    'Conecto Entrepreneur is a submission platform that finds qualified applicants for its network of roofers certified by the Régie du Bâtiment du Québec.',
  metaKeywords: 'roofing submission, roofing quote, find rooftop client, roofing marketing',
