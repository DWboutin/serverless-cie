...
const messages = defineMessages({
  ...
  signIn_form_confirmation_notice_description:
    'Un code de confirmation a été envoyé à cette adresse "{email}". Vous serez redirigé vers la page de confirmation où vous pourrez utiliser ce code pour confirmer votre compte.',

  signIn_passwordReset_form_title: 'Nouveau mot de passe',
  signIn_passwordReset_form_text: 'Ce mot de passe sera utilisé pour vous connecter sur la plateforme Conecto Entrepreneur.',

  signUp_form_hasAccount: 'Vous avez déjà un compte ?',
  signUp_form_iHaveAnAccount: "J'ai déjà un compte",
  signUp_form_button_signIn: 'Connectez-vous',
  signUp_form_title: 'À la recherche de nouveaux clients ?',
  signUp_form_checkpoint1:
    'Conecto vous met en contact avec des demandeurs qualifiés dans votre région',
  signUp_form_checkpoint2: 'Gèrez facilement vos soumissions en toute sécurité',
  signUp_form_checkpoint3: "Facile, flexible. Pour tout type d'entrepreneurs",
  signUp_form_labelCompany: "Nom de l'entreprise",
  signUp_form_labelUsername: 'Courriel',
  signUp_form_labelPassword: 'Mot de passe',
  signUp_form_button: 'Créer mon compte entrepreneur',
  signUp_form_labelCompanyName: "Nom de l'entreprise",
  signUp_form_labelCompanyNumber: 'Numéro civique',
  signUp_form_labelCompanyAddress: "Adresse de l'entreprise",
  signUp_form_labelCompanyCity: "Ville de l'entreprise",
  signUp_form_labelCompanyPostalCode: "Code postal de l'entreprise",
  signUp_form_labelFirstName: 'Prénom',
  signUp_form_labelLastName: 'Nom de famille',
  signUp_form_labelPhone: 'Numéro de téléphone mobile',
  signUp_form_labelConfirmPassword: 'Confirmation de mot de passe',
  signUp_form_labelRBQ: 'RBQ',
  signUp_form_labelNEQ: 'NEQ',
  signUp_form_labelMailing: "S'abonner à l'infolettre",
  signUp_form_labelCondition: "Accepter les conditions d\'utilisation",
  signUp_step2_form_title:
    'Avant de terminer le processus, nous avons  encore besoin de quelques <span>informations</span>.',
  signUp_step2_form_companyTitle: "Informations de l'entreprise",
  signUp_step2_form_companyAddressTitle: 'Adresse trouvée',
  signUp_step2_form_contactTitle: 'Informations de contact',
  signUp_step2_form_accountTitle: 'Informations de connexion',
  signUp_step2_form_legalTitle: 'Informations légales',
  signUp_step2_form_acceptationTitle: 'Infolettre',
  signUp_step2_form_acceptationText:
    'Nous vous garderons à l’affût de toutes les nouvelles fonctionnalités à venir sur la plateforme.',
  signUp_step2_form_acceptationConditionText:
    'Voir les conditions d\'utilisation',
  signUp_step2_submit_button: 'Soumettre',
  signUp_confirmation_modal_title: 'Votre inscription est terminée',
  signUp_confirmation_modal_text:
    'Un code de confirmation vous a été envoyé par courriel. Vous serez redirigé vers la page de confirmation pour procéder à la confirmation de votre compte.',
  signUp_confirmation_modal_button: 'Confirmer le compte',
  code_confirmation_modal_title: 'Votre compte a bien été confirmé',
  code_confirmation_modal_text:
    'Votre inscription est maintenant confirmée. Vous pouvez maintenant vous connecter.',
  code_confirmation_modal_button: 'Connectez-vous',
  codeConfirmation_form_title:
    '<span>Confirmez votre inscription</span> en inscrivant le code de confirmation que vous avez reçu par courriel',
  codeConfirmation_form_labelUsername: 'Courriel',
  codeConfirmation_form_labelPassword: 'Mot de passe',
  codeConfirmation_form_labelCode: 'Code de confirmation',
  codeConfirmation_form_button_confirmMyAccount: 'Confirmer mon compte',
  codeConfirmation_accountIsConfirmed: 'Votre compte a déjà été confirmé?',
  passwordResetRequest_form_title:
    'Réinitialisation du mot de passe',
  passwordResetRequest_form_text:
    'Un courriel contenant un code de réinitialisation de mot de passe vous a été envoyé.',
  passwordResetRequest_form_button: 'Réinitialiser',
  passwordResetRequest_form_labelUsername: 'Courriel',
  passwordReset_form_labelNewPassword: 'Nouveau mot de passe',
  passwordReset_form_labelNewPasswordConfirmation:
    'Confirmation du nouveau mot de passe',
  passwordReset_form_labelCode: 'Code',
  passwordReset_form_button: 'Réinitialiser le mot de passe',
  passwordReset_passwordIsOk: 'Votre mot de passe est correct ?',
  passwordReset_modal_title: 'Votre mot de passe a été réinitialisé',
  passwordReset_modal_text:
    'Vous pouvez maintenant vous connecter avec le nouveau mot de passe',
  passwordReset_modal_button: 'Connectez-vous',
  passwordReset_form_title: 'Inscrivez le nouveau mot de passe',
  passwordReset_form_text:
    'Veuillez inscrire le code de réinitialisation et inscrire le nouveau mot de passe. Vous pourrez ensuite vous connecter.',
  ...
  layoutDashboard_ctaSection_title:
    'Profitez pleinement de <span>Conecto</span> en ajustant les préférences de votre profil',
  ...
  dashboardPage_stats_title_competitors: 'Réseau Conecto',
  ...
  cognito_CodeMismatchException: 'Le code est invalide',
  ...
  signIn_form_temporaryPassword_resend_title: 'Un mot de passe temporaire a été généré',
  signIn_form_temporaryPassword_resend_description: 'Vous receverez sous-peu un courriel avec un mot de passe temporaire pour vous connecter.',
  signIn_form_notice_error_undefinedCode_title: 'Une erreur est survenue',
  signIn_form_notice_error_undefinedCode_description:
    "Le système n'a pu prodécéder la requête. Veuillez contacter le support et transmettre les informations suivantes:\n\n{code}",
  ...
  generic_component_error_description:
    'Des erreurs système sont survenues lors des dernières opérations. Veuillez contacter le support et transmettre les informations suivantes:\n\n{error}\n\n{info}',
  ...
  opportunity_paymentMethod_modal_title:
    'Vous devez avoir déterminé une méthode de paiement dans le profil',
  opportunity_paymentMethod_modal_text:
    'Vous devez avoir une méthode de paiement valide pour pouvoir accepter les opportunités. Veuillez cliquer sur le bouton ci-dessous pour en ajouter une.',
  ...
  opportunity_acceptedDeal_modal_text:
    'Cette opportunité a été transférée dans l\'onglet "En cours". Vous pouvez cliquer sur le bouton pour la consulter.',
  ...
  opportunity_empty_section_text:
    "Ceci est la page qui liste les opportunités qui vous ont été assigné. Si l'opportunité est encore disponible, vous pourrez la voir affichée ici.",
  lead_empty_section_title: 'Pas d’opportunité en cours',
  lead_empty_section_text:
    'Ceci est la page qui liste les opportunités que vous avez accepté. Vous y trouverez les informations de vos demandeurs et pourrez les contacter selon leurs préférences de contact.',
  lead_call_ongoing_modal_title: 'Nous vous appellerons très bientôt',
  ...
  account_paymentMethod_source_make_default_notice_title:
    'Modification de la méthode de paiement par défaut',
  ...
  account_addressesForm_addressesLimitReached:
    "Vous avez atteint la limite du nombre d'adresse que vous pouvez entrer. Si vous avez besoin d'ajouter d'autres adresses, veuillez contacter le support.",
  ...
  account_myAccountForm_changePasswordTitle: 'Modifier le mot de passe',
  ...
  account_myAccountForm_signInInfos_notice_wrongPassword_text:
    'Veuillez écrire votre ancien mot de passe.',
  ...
  labelJobInfoAccordionTitle: 'Plus d\'informations',
  button_404_back_homepage: "Retour à l'accueil",
  ...
  validationFieldMinLength2: 'Doit contenir 2 caractères ou plus',
  validationFieldMinLength8: 'Doit contenir 8 caractères ou plus',
  validationFieldMaxLength50: 'Doit contenir 50 caractères ou moins',
  validationFieldMaxLength200: 'Doit contenir 200 caractères ou moins',
  ...
  validationMustAccept: 'Vous devez accepter les conditions d\'utilisation',
  ...
  metaDescription:
    'Conecto Entrepreneur est une plateforme de soumission qui trouve des demandeurs qualifiés pour son réseau de couvreurs certifiés par la Régie du Bâtiment du Québec.',
  metaKeywords: 'soumission toiture, soumission couvreur, trouver client toiture, marketing toiture',
  ...
  signup_tos_confirmation_modal_scroll_info:
    'Clique ici pour voir les conditions d\'utilisation',
