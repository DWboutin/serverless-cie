...
describe('Input', () => {
  ...
  it('should match snapshot', () => {
    const wrapper = (0, _enzyme.shallow)(_react.default.createElement(_Input.default, {
      id: "test-input",
      name: "test-input"
    }));
  ...
  it('should have the "focused" class when focus on input', () => {
    const wrapper = (0, _enzyme.mount)(_react.default.createElement(_Input.default, {
      id: "test-input",
      name: "test-input",
  ...
  it('should handle onBlur correctly when no function is passed', () => {
    ...
    wrapper.find('input').last().instance().value = 'Test';
    wrapper.find('input').last().simulate('blur');
  ...
  it('should console.error when no id is set', () => {
    (0, _enzyme.shallow)(_react.default.createElement(_Input.default, {
      name: "test-input"
    }));
  ...
  it('should render a string label correctly', () => {
    ...
    expect(wrapper.find('Label').getElement().props.htmlFor).toEqual('test-input');
    wrapper.unmount();
  });
  it('should render a component label correctly', () => {
    ...
    expect(wrapper.find('.to-input-label').find('span').text()).toEqual('Test');
    expect(wrapper.find('.to-input-label').getElement().props.htmlFor).toEqual('test-input');
  });
