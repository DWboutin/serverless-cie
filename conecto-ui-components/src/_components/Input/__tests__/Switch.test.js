...
describe('Switch', () => {
  ...
  it('should match snapshot', () => {
    const wrapper = shallow(
      <Switch id="test-switch" name="test-switch" label="test" />
    )
  ...
  it('should match snapshot with checked prop', () => {
    const wrapper = shallow(
      <Switch id="test-switch" name="test-switch" label="test" checked />
    )
  ...
  it('should have the prefix class', () => {
    ...
    expect(wrapper.instance().classesPrefix).toEqual('to-switch')
  ...
  it('should have the "focused" class when passed as prop', () => {
    const wrapper = shallow(
      <Switch id="test-switch" name="test-switch" label="test" focused />
    )
  ...
  it('should console.error when no label is set', () => {
    shallow(<Switch id="test-switch" name="test-switch" />)
  ...
  it('should render a string label correctly', () => {
    const wrapper = mount(
      <Switch id="test-input" name="test-input" label="Test label" />
    )

    expect(wrapper.find('.to-switch-label').length).toEqual(1)
    expect(wrapper.find('.to-switch-label').text()).toEqual('Test label')
  ...
  it('should render a component label correctly', () => {
    const wrapper = shallow(
      <Switch id="test-input" name="test-input" label={<span>Test</span>} />
    )

    expect(wrapper.find('.to-switch-label').length).toEqual(1)
    expect(wrapper.find('.to-switch-label').find('span').length).toEqual(1)
    expect(
      wrapper
        .find('.to-switch-label')
        .find('span')
        .text()
    ).toEqual('Test')
  ...
  it('should not render an error by default', () => {
    const wrapper = shallow(
      <Switch id="test-input" name="test-input" label="Test" />
    )
