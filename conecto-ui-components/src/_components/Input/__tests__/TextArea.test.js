...
describe('TextArea', () => {
  ...
  it('should match snapshot', () => {
    const wrapper = shallow(
      <TextArea id="test-textarea" name="test-textarea" />
    )
  ...
  it('should match snapshot with an injected value in props', () => {
    const wrapper = shallow(
      <TextArea id="test-textarea" name="test-textarea" value="hello" />
    )
  ...
  it('should handle onChange correctly when no function is passed', () => {
    const wrapper = mount(<TextArea id="test-textarea" name="test-textarea" />)
    const event = { target: { name: 'keyUp', value: 'test' } }
    wrapper
      .find('textarea')
      .last()
  ...
  it('should handle onBlur correctly', () => {
    const wrapper = mount(
      <TextArea id="test-textarea" name="test-textarea" onBlur={onBlur} />
    )
    wrapper
      .find('textarea')
      .last()
  ...
  it('should console.error when no id is set', () => {
    shallow(<TextArea name="test-textarea" />)

    expect(global.console.error).toBeCalled()
  })

  it('should console.error when no name is set', () => {
    shallow(<TextArea id="test-textarea" />)
  ...
  it('should render a string label correctly', () => {
    const wrapper = mount(
      <TextArea id="test-textarea" name="test-textarea" label="Test label" />
    )
  ...
  it('should render a component label correctly', () => {
    ...
    expect(
      wrapper
        .find('.to-textarea-label')
        .find('span')
        .text()
    ).toEqual('Test')
    expect(
      wrapper.find('.to-textarea-label').getElement().props.htmlFor
  ...
  it('should render a string error correctly', () => {
    const wrapper = mount(
      <TextArea id="test-textarea" name="test-textarea" error="Test error" />
    )
